...
public class RFPManager extends TabFeature {
    ...
    public String addRFP(String name) {
        ...
        for (TabPlayer p : tab.getOnlinePlayers()) {
            ...
            String prefix = TABAdditions.getInstance().parsePlaceholders(rfp.getProps(p)[0],p);
            String suffix = TABAdditions.getInstance().parsePlaceholders(rfp.getProps(p)[1],p);
